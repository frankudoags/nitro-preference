...
namespace margelo::nitro::nitropreferences {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitropreferences/Variant_NullType_Boolean;";
  ...
  namespace JVariant_NullType_Boolean_impl {
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitropreferences/Variant_NullType_Boolean$First;";
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitropreferences/Variant_NullType_Boolean$Second;";
