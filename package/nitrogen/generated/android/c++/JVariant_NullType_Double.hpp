...
namespace margelo::nitro::nitropreferences {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitropreferences/Variant_NullType_Double;";
  ...
  namespace JVariant_NullType_Double_impl {
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitropreferences/Variant_NullType_Double$First;";
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitropreferences/Variant_NullType_Double$Second;";
